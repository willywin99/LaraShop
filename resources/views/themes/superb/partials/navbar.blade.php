...
<nav>
    <div class="container">
          <!-- Header Logo -->
          <div class="logo"><a title="Datson" href="index.html"><img alt="Datson" src="{{ asset('themes/superb/assets/images/logo.png') }}"></a></div>
          <!-- End Header Logo -->
        ...
        <div class="mm-toggle-wrap">
          ...
          <ul class="nav hidden-xs menu-item menu-item-left">
            <li class="level0 parent drop-menu active"><a href="{{ asset('themes/superb/assets/index.html') }}"><span>Home</span></a>
            ...
            <li class="level0 parent drop-menu"><a href="{{ url('products') }}"><span>Shop</span> </a>
              <ul class="level1" style="display: none;">
                <li class="level1 first"><a href="grid.html"><span>Grid</span></a></li>
                <li class="level1 nav-10-2"> <a href="list.html"> <span>List</span> </a> </li>
                <li class="level1 nav-10-3"> <a href="product_detail.html"> <span>Product Detail</span> </a> </li>
              ...
              <div style="left: 0px; display: none;" class="level0-wrapper dropdown-6col">
                <div class="container">
                  <div class="level0-wrapper2">
                    ...
                    <div class="col-2">
                      <div class="menu_image"><a href="#" title=""><img src="{{ asset('themes/superb/assets/images/menu_image.png') }}" alt="menu_image"></a></div>
                    </div>
                  </div>
                  <!--level0-wrapper2--> </div>
              </div>
